...
export type ElysiaInstance<Instance extends {
    ...
    meta?: Record<typeof SCHEMA, Partial<OpenAPIV3.PathsObject>> & Record<typeof DEFS, Record<string, unknown>> & Record<typeof EXPOSED, Record<string, Record<string, unknown>>>;
} = {
    store: {};
    request: {};
    schema: {};
...
export type UnwrapSchema<Schema extends TSchema | undefined | string, Definitions extends ElysiaInstance['meta'][typeof DEFS] = {}, Fallback = unknown> = Schema extends string ? Definitions extends Record<Schema, infer NamedSchema> ? NamedSchema : Definitions : Schema extends TSchema ? Static<NonNullable<Schema>> : Fallback;
...
export type HookHandler<Schema extends TypedSchema = TypedSchema, Instance extends ElysiaInstance = ElysiaInstance, Path extends string = string, Typed extends AnyTypedSchema = TypedSchemaToRoute<Schema, Instance['meta'][typeof DEFS]>> = Handler<Typed extends {
    body: infer Body;
...
export type LocalHandler<Schema extends TypedSchema, Instance extends ElysiaInstance, Path extends string = string> = Handler<MergeSchema<Schema, Instance['schema']> extends infer Typed extends TypedSchema<any> ? TypedSchemaToRoute<Typed, Instance['meta'][typeof DEFS]> extends {
    body: infer Body;
    params: infer Params;
    query: infer Query;
    headers: infer Headers;
